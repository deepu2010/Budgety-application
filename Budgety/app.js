...
//Inheriting from expense function constructor 
 ...
 //Writing a function for returning the percentage value
...
return {
    ...
    addItem: function(type, des, val)
    {
     ...
     deleteItem: function(type, id) {
            ...
            //converting income type as inc and expense type as exp
            if(type === "income")
                {
                    type = "inc";
                }
...
var UIController = (function ()
   ...
   var DOMstrings = {
       ...
       expensesLablel: '.budget__expenses--value',
        ...
        getInput: function()
    {
        ...
        clearFields: function()
        {
            ...
            //setting the start of the cursor at the description
            fieldsArr[0].focus();
        },
        ...
        displayBudget: function(obj)
    {
       ...
       obj.budget > 0 ? type = 'inc' : type = 'exp';  document.querySelector(DOMstrings.budgetLabel).textContent = formatNumber(obj.budget, type);
         ...
         document.querySelector(DOMstrings.expensesLablel).textContent = formatNumber(obj.totalExp, 'exp');
...
var controller = (function(budgtCtrl, UIctrl)
                 {
    //CREATING A SEPARATE function to accomodate all the event listeners
    ...
    //function for updating the percentages on the screen
    
    var updatePercentage = function()
    {
        //1.Calculate Percentage
        budgtCtrl.calcuatePercentages();
        
        //2.Read the percentage from the budget controller
        var percentages = budgtCtrl.getPercentages();
        //3.Update the percentage from the budget controller
    ...
    var ctrlitem = function()
    {
        ...
        //checking if the description and the value field is not equal to 0
    ...
    return {
        init: function()
        {
            ...
            //calling month and year
            UIctrl.displayMonth();
            //clearing all the values, passing a object with initial values in displauBudget 
